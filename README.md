...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/black-scene-a5f8)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/black-scene-a5f8
```

A live public deployment of this template is available at [https://black-scene-a5f8.templates.workers.dev](https://black-scene-a5f8.templates.workers.dev)
